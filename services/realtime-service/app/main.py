"""Punto de entrada del servicio de tiempo real (Socket.IO + REST)."""
...
app = FastAPI(
    title="ViajIAmos - Realtime Service",
    description="Eventos de viajes en tiempo real vía Socket.IO",
    version="1.0.0",
)
...
# Monta Socket.IO sobre ASGI: /socket.io/
